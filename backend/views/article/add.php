                                ...
                                <div class="charge_sy">
                                    ...
                                    <div class="layui-block" style="margin: 5px 0;">
                                        ...
                                        <div class="layui-input-block">
                                            <input name="title" type="text" id="title" class="layui-input" lay-verify="required|Name" placeholder="文章标题">
                                        </div>
                                    </div>
                                    <div class="layui-block" style="margin: 5px 0;">
                                    ...
                                    <div class="layui-block" style="margin: 5px 0;">
                                        ...
                                        <div class="layui-input-block">
                                            <textarea ols="30" rows="10" name="description" type="text" id="description" class="layui-textarea" lay-verify="required|Name" placeholder="文章描述"></textarea>
                                        </div>
                                    </div>
                                    <div class="layui-block" style="margin: 5px 0;">
                                    ...
                                    <div class="layui-block" style="margin: 5px 0;">
                                        ...
                                        <div class="layui-input-block">
                                            <input name="url" type="text" id="url" class="layui-input" lay-verify="required" placeholder="10位字符串">
                                        </div>
                                    </div>
                                    <div class="layui-block" style="margin: 5px 0;">
                                        <label class="layui-form-label">外部URL：</label>
                                        <div class="layui-input-block">
                                            <input name="out_url" type="text" id="out_url" class="layui-input" lay-verify="required" placeholder="外部URL">
                                        </div>
                                    </div>
                                    ...
                                    <div class="layui-block" style="margin: 5px 0;">
                                        <div class="form-group smallpic">
                                            ...
                                            <p>最大100KB，封面图。</p>
                                            <div id="preview">
                                                <img src="http://www.people.com.cn/NMediaFile/2017/1215/MAIN201712150858517959131402168.jpg" alt="..." class="img-thumbnail">
                                            </div>
